  ...
  items = [
    {
      value: "15,000",
      suffix: "+",
      description: "Customers saved with Perq deals",
    },
    {
      value: "40%",
      suffix: "+",
      description: "Average increase in weekly foot traffic for partners",
    },
    {
      value: "$1.2M",
      suffix: "+",
      description: "Total revenue driven for local restaurants",
    },
    {
      value: "200",
      suffix: "+",
      description: "Exclusive restaurant partners on Perq",
    },
  ],
  className,
}: StatsProps) {
